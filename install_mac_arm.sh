...
cd $HOME/zephyr_install && curl -L -O https://github.com/zephyrproject-rtos/sdk-ng/releases/download/v0.17.4/zephyr-sdk-0.17.4_macos-aarch64_minimal.tar.xz
tar xvf $HOME/zephyr_install/zephyr-sdk-0.17.4_macos-aarch64_minimal.tar.xz -C $HOME/zephyr_install
rm $HOME/zephyr_install/zephyr-sdk-0.17.4_macos-aarch64_minimal.tar.xz
